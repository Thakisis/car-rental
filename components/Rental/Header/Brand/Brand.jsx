...
function Brand({ brand }) {
    ...
    return (
        <div className="absolute  left-0 top-0 z-9  color-white  brandcont " >
            <div ref={elementRef} className="  text-blue-400 font-bold brand  whitespace-nowrap" >{brand.toUpperCase()}</div>
        </div>
    )
}
